...
var wobbleSpeed = 10;
var wobbleDist = 0.02;
Hurt.prototype.act = function(step){
...
Player.prototype.moveY = function(step, level, keys) {
  ...
  var newPos = this.pos.plus(motion);
 // var returnStart = (return);
  var obstacle = level.obstacleAt(newPos, this.size);
  
  // the floor is also an obstacle. play can only jump if they are touching an obstacle.
  if (obstacle) {
